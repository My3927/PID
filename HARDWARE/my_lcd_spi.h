...
#define LCD_CLK     WritePin(B,7)
#define LCD_MOSI    WritePin(B,8)
#define LCD_RES     WritePin(B,9)
#define LCD_DC      WritePin(B,10)

#ifdef LCD_1_4 //采用1.44寸屏
#define LCD_CS1     WritePin(B,11)
#define LCD_LED     WritePin(B,12)
 static const MyPinDef Pins_LCD_ILI9341[] = {PB7,PB8,PB9,PB10,PB11,PB12};
